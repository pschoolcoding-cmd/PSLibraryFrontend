...
import { BookOpen, Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, AlertCircle, User, X } from 'lucide-react';
...
export default function Login() {
  ...
  const handleOAuthLogin = useGoogleLogin({
    ...
    onError: () => {
      // Open custom Google Account Chooser popup if OAuth client ID isn't registered on Google Console yet
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white flex flex-col justify-between selection:bg-blue-500 selection:text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-[400px] h-[400px] bg-violet-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-28 relative z-10">
        <div className="w-full max-w-md bg-[#0b0b0e]/80 border border-gray-800/80 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl backdrop-blur-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <div className="w-12 h-12 rounded-2xl bg-blue-600/10 border border-blue-500/30 flex items-center justify-center mx-auto mb-4 text-blue-400 shadow-inner">
            ...
            <p className="text-gray-400 text-xs sm:text-sm mt-1.5 font-medium">
              Sign in to your Grand Library Reader account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#121216] border border-gray-800 focus:border-blue-500 text-white text-xs sm:text-sm rounded-2xl pl-10 pr-4 py-3.5 transition-all outline-none focus:ring-2 focus:ring-blue-500/20"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full bg-[#121216] border border-gray-800 focus:border-blue-500 text-white text-xs sm:text-sm rounded-2xl pl-10 pr-10 py-3.5 transition-all outline-none focus:ring-2 focus:ring-blue-500/20"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-blue-600 hover:bg-blue-500 active:scale-95 text-white font-black text-xs sm:text-sm py-3.5 px-4 rounded-2xl transition-all shadow-xl shadow-blue-600/30 flex items-center justify-center gap-2 cursor-pointer uppercase tracking-wider font-[Outfit]"
            >
              {loading ? (
      ...
      <footer className="py-6 text-center text-xs text-gray-600 border-t border-gray-900/60 relative z-10">
        <p className="flex items-center justify-center gap-1.5">
          ...
          Protected by Grand Library OAuth & Encrypted Reader Security
        </p>
      </footer>
    </div>
  );
